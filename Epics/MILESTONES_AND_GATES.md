...
| 2026-03-04 | G9   | In Progress | Token-efficiency hardening track initialized (EPIC-I / TERP): transport text dedupe strategy, `tools/list` detail modes, low-token config defaults, and regression-test coverage added for compact-by-default behavior.                                                                                                                                                          |
