...
C. **Companion App** (authoritative endpoints + versioning)  
...
### Phase 3 (Weeks 6–8): Companion App + ACL Trace Authoritative Mode
- Companion app packaging, version contract
...
### Epic C1: Companion App Packaging & Version Contract
**Tasks**
...
- Missing/outdated results in explicit degradation output
...
- Discovery mode still works without Companion but declares limitations
